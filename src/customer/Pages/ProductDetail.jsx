...
// const API_URL = 'https://amrti-main-backend.vercel.app/api/v1/amrti/products'; // Replace with your actual backend URL

// export default function ProductDetail() {
//   const {productId}=useParams()
//   const [selectedType, setSelectedType] = useState('tin'); // Default selected type
...
//         console.log(data)
//         setProductData(data.data.data); // Assume the API returns the product details
//       } catch (err) {
...
//     toast.success(`${productData.name} added to cart successfully!`);
//   };
...
//                 </p>
//                 <p className="text-green-600 font-semibold">
//                   {((productData.price - productData.discountedPrice) / productData.price * 100).toFixed(0)}% Off
//                 </p>
//               </div>
...
//           </div>
//           <div className="grid gap-8 row-gap-10 lg:grid-cols-2">
//             {productData.product?.why.map((why, index) => (
...
//         <div className="px-4 py-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-20">
//           <h2 className="text-center mb-6 font-sans text-3xl font-bold leading-none tracking-tight text-gray-900 sm:text-4xl md:mx-auto">
//             <p>Ways to Enjoy Our {productData.product?.title}</p>
//           </h2>
//           <div className="grid gap-8 lg:grid-cols-3 sm:max-w-sm sm:mx-auto lg:max-w-full">
//             {productData.product?.enjoy.map((enjoy, index) => (
...
//                 <Button 
//                   variant={selectedType === 'tin' ? "contained" : "outlined"} 
//                   onClick={() => handleSelectType('tin')}
//                 >
//                   Powder Tin
//                 </Button>
//                 <Button 
//                   variant={selectedType === 'pouch' ? "contained" : "outlined"} 
//                   onClick={() => handleSelectType('pouch')}
//                 >
//                   Pouch
//                 </Button>
//               </div>
