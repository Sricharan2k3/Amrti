...
const Food = () => {
  const categories = [
    { title: 'Moringa Avocado Toast', image: 'https://d33hqsk72xx8w2.cloudfront.net/wp-content/uploads/unnamed-8.png',url:"/product/moringa/recipes/easy-to-use/moringa-toast" },
    { title: 'Moringa Uttapam', image: 'https://d33hqsk72xx8w2.cloudfront.net/wp-content/uploads/dosa-moringa-scaled.jpg',url:"/product/moringa/recipes/easy-to-use/moringa-uttapam" },

    { title: 'Moringa Leaf Chutney Rice', image: 'https://d33hqsk72xx8w2.cloudfront.net/wp-content/uploads/unnamed-9.png',url:"/product/moringa/recipes/easy-to-use/moringa-rice" },
