...
const Beverage = () => {
  const categories = [
    { title: 'Moringa Iced Tea', image: 'https://d33hqsk72xx8w2.cloudfront.net/wp-content/uploads/unnamed-5.png' },
    { title: 'Moringa Tea', image: 'https://d33hqsk72xx8w2.cloudfront.net/wp-content/uploads/tea-moringa-scaled.jpg' },
  ];
          ...
          {categories.map((category, index) => (
            <div key={index} className="flex flex-col">
              <div className="bg-gray-300 aspect-video  mb-2 flex items-center justify-center text-gray-600">
                <img src={category.image} className='h-[145px] w-[172px]' alt="" />
              </div>
